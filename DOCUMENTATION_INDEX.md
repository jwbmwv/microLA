...
| [Cpp_Standard_Optimizations.md](docs/Cpp_Standard_Optimizations.md) | C++11-C++26 feature usage |
...
| [cpp_standard_features.puml](design/cpp_standard_features.puml) | C++11-C++26 progressive enhancement |
...
**Generate diagrams:**
```bash
# Windows (requires Java, PlantUML 1.2025.10, Batik 1.19)
...
| [sensor_fusion.cpp](examples/sensor_fusion.cpp) | IMU sensor fusion with quaternions |
...
- **Batik Version:** 1.19
- **Location:** `C:\Users\think\bin\`
- **Script:** [generate_diagrams.bat](generate_diagrams.bat)

### Build System
- **CMake:** 3.20+ required
- **C++ Standard:** C++11 minimum (C++26 recommended)
...
- Add new examples for frequently requested features
- Review and update TROUBLESHOOTING.md

## 📝 License

All documentation is part of MicroLA and licensed under the MIT License.
