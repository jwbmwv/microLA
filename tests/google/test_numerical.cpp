...
TEST(Numerical, KahanSumBasic)
{
    ...
    auto result = kahan_sum<float>(values.begin(), values.end());
...
TEST(Numerical, KahanSumAccuracy)
{
    ...
    auto kahan_result = kahan_sum<float>(values.begin(), values.end());
...
TEST(Numerical, KahanSumEmpty)
{
    ...
    auto result = kahan_sum<float>(empty.begin(), empty.end());
...
TEST(Numerical, DoublePrecision)
{
    ...
    auto sum = kahan_sum<double>(values.begin(), values.end());
