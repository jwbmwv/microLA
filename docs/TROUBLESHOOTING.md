...
FetchContent_Declare(microla
    GIT_REPOSITORY https://github.com/yourusername/microla.git
    GIT_TAG main
)
...
[env:myboard]
lib_deps =
    https://github.com/yourusername/microla.git
...
2. **Search issues**: https://github.com/yourusername/microla/issues
3. **Ask on discussions**: https://github.com/yourusername/microla/discussions
