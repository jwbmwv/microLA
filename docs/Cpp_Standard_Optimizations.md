...
MicroLA is designed for C++11 compatibility but takes advantage of newer C++ standards when available.
...
```cpp
// C++11 (baseline)
// C++14: MICROLA_CONSTEXPR14, relaxed constexpr
// C++17: MICROLA_CONSTEXPR17, MICROLA_IF_CONSTEXPR, MICROLA_INLINE_VAR, MICROLA_NODISCARD
...
MICROLA_INLINE_VAR constexpr int X = 0;
```
...
**Library Support:** MicroLA 1.0.0 is ready - rotation functions automatically become `constexpr` when compiled with C++26
