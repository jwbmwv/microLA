...
#ifndef _MICROLA_VERSION_HPP_
#define _MICROLA_VERSION_HPP_
...
#define MICROLA_VERSION_NUMBER \
    ((MICROLA_VERSION_MAJOR * 10000) + (MICROLA_VERSION_MINOR * 100) + MICROLA_VERSION_PATCH)
